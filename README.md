...
<body>
    ...
    <footer id="contact" class="bg-dark text-white text-center py-4">
        <div class="container">
            <p class="mb-0">&copy; 2025 Designed and developed by SHARMA.R(212224230261). All rights reserved.</p>
        </div>
    </footer>
...
```
## OUTPUT:
![Screenshot (28)](https://github.com/user-attachments/assets/d5266699-ca6b-42f7-932c-15d8db0086e0)
